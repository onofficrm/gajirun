    ...
    <footer className="bg-[#0F141F] text-slate-400 text-sm border-t border-[#1F293D]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
          ...
          <div className="md:col-span-2 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-white font-bold text-lg">오산개인회생 지원센터</span>
            </div>
        ...
        <div className="pt-8 border-t border-[#1C2538] text-[11px] text-slate-400 space-y-2 leading-relaxed">
          <p>
            상호: 오산개인회생 | 관할: 수원회생법원 | 오산시 세교·대원·궐동·금암 개인회생·개인파산 상담
          </p>
          <p>
            오산 지역 비대면 상담 가능 | 대표전화: 0503-6982-1000 | 카카오톡: @희망도우미
          </p>
          <p className="text-slate-400">
            [변호사법 준수 표기] 본 웹사이트의 모든 법률 자문 및 사건 수임은 소속 도산 전문 변호사의 직접 지휘와 검토하에 수행됩니다. 개인회생 및 개인파산 제도의 구체적인 결과(변제금 및 탕감률)는 신청인의 소득, 재산, 채무 성격 및 관할 법원의 실무준칙에 따라 달라질 수 있습니다.
          </p>
          <div className="flex flex-wrap items-center justify-between gap-4 pt-4 text-slate-400 border-t border-[#182030] mt-4">
            <div>© 2026 오산개인회생. All rights reserved.</div>
            <div className="flex items-center gap-3">
