          ...
          faqs: [
            {
              ...
              a: '법원이 지정한 변호사(파산관재인) 사무실에 출석하여 약 15~30분간 질문을 받습니다. 과거 재산 처분 내역과 채무 발생 경위를 묻는데, 오산개인회생 법률지원센터가 사전 모의 코칭과 예상 답변서를 완벽히 준비해 드립니다.',
            },
            {
        ...
        return {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: '네, 가능합니다. 대법원 전자소송 시스템을 통해 오산·경기남부(수원회생법원)뿐만 아니라 서울, 부산, 대구, 광주 등 전국 모든 관할 법원 사건을 방문 없이 원스톱 비대면으로 신속하게 처리해 드립니다.',
            },
          ],
        };
    }
